...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="container mainbox"  ng-controller="chartsController" style="text-align: center;">
                <h1 class="center"> ${gameentry.gameName} Report Charter </h1>
                <div ng-repeat="(key, param) in charts.list.drawlist" 
                     google-chart chart-no="{{key}}" ></div>
                <div id="buttonplace" class="">
    ...
    <script type="text/javascript" src="/CloudGameReport/res/js/gameCharter.js"></script>
</html>
